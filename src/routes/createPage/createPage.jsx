...
const CreatePage = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      resetStore();
            toast.success("Your pin has been created!");
  ...
  const { data, isPending, error } = useQuery({
    queryKey: ["formBoards"],
    queryFn: () => apiRequest.get(`/boards${data._id}`).then((res) => res.data),
  });
          ...
          {previewImg.url ? (
            <div className="preview">
              ...
              <div className="editIcon" onClick={() => setIsEditing(true)}>
                <Images src="/general/edit.svg" alt="" />
              </div>
            </div>
          ) : (
            <>
              <label htmlFor="file" className="upload">
                <div className="uploadTitle">
                  <Images src="/general/upload.svg" alt="" />
